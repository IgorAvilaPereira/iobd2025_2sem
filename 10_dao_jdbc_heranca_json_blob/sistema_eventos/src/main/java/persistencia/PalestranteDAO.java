...
public class PalestranteDAO {
    ...
    public List<Palestrante> listar(Connection conexao) throws SQLException {
     ...
     public List<Palestrante> listar(Connection conexao, int palestra_id) throws SQLException {
